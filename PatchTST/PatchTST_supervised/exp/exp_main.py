...
from models import Informer, Autoformer, Transformer, DLinear, Linear, NLinear, PatchTST, HaarDCTPatchTST, HaarPatchTST
...
class Exp_Main(Exp_Basic):
    ...
    def _build_model(self):
        model_dict = {
            ...
            'Linear': Linear,
            'PatchTST': PatchTST,
            'HaarDCTPatchTST': HaarDCTPatchTST,
            'HaarPatchTST': HaarPatchTST,
        }
